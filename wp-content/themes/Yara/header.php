...
<body <?php body_class('yaraHome'); ?>>
    ...
    <div class="generaldivigation" id="generaldivigation">
        <div class="logoHolder">
            <h1>
                <a href="yaraHome.html"><img src="<?php echo (get_template_directory_uri()) ?>/assets/images/YaraLogo.webp?v=25" width="48" height="48" alt="Yara Digital Products"></a>
            </h1>
            <h2>
                <a href="yaraHome.html"><img src="<?php echo (get_template_directory_uri()) ?>/assets/images/pixel.png?v=45" id="atfarmLogo" width="162" height="48" alt="Atfarm"></a>
            </h2>
        </div>
        <nav>
