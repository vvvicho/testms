<section id="contentList" class="section bgColors--sectionLight">
            <div class="warper">
                <h3 class="item_12">When to use the N-Tester BT? </h3>
                ...
                <figure class="item_7">
                    <img src="../HTML/assets/images/fc.webp" width="677" height="508" alt="my image">
                </figure>
            </div>
        </section>