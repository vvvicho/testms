...
<li class="adminHolder--leftNav--templatesList--button" onClick="insertMySection(this)" data-type="template gallery">
    <figure>
        <img src="/wp-content/plugins/YaraCompanion/assets/imagesAdmin/gallery_x6.png" alt="section content">
        <span>Gallery Section Flexy</span>
    </figure>
    <templateHidden data-repeat="1" data-head="0" data-used="0">
        <div class="bgColors--sectionLNormal section">
            <div class="warper warper--gallery warper--gallery--flex">
                <h3 class="item_6" data-edit="text">H3 Headline</h3>
                <div class="galleryItem" data-edit="delete duplicateItem">
