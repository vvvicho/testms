...
<li class="adminHolder--leftNav--templatesList--button" onClick="insertMySection(this)" data-type="template gallery">
    <figure>
        <img src="<?php echo (YARA_CC_PATH . 'assets/imagesAdmin/slider.png'); ?>" alt="section content">
        ...
        <div id="contentSlider" class="bgColors--sectionLNormal section">
            <div class="warper">
                ...
                <div class="slider item_12">
                    <ul>
                        <li data-edit="duplicateItem">
                            <figure data-edit="image delete">
                                <img src="<?php echo (YARA_CC_PATH . 'assets/imagesAdmin/placeHolders/img_315_315.png'); ?>" width="315" height="315" alt="my image">
                            </figure>
                            <i class="counter">x</i>
